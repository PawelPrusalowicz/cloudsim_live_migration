...
import static org.cloudbus.cloudsim.core.CloudSimTags.VM_CREATE;
import static org.cloudbus.cloudsim.core.CloudSimTags.VM_INITIATE_PRE_COPY_MIGRATION;
...
//			vmCopy.setHost(vm1.getHost());
			...
			migrate.put("vmSource", vm1);
			migrate.put("migrationSourceHost", vm1.getHost());
			migrate.put("migrationDestinationHost", datacenter0.getHostList().get(1));


			//Initiate pre-copy migration process
			CloudSim.send(datacenter0.getId(), datacenter0.getId(), 0, VM_INITIATE_PRE_COPY_MIGRATION,  migrate);
